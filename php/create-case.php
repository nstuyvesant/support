...
if($_POST) {
  ...
  $case->Subject = filter_var(htmlspecialchars_decode($_POST['subject']), FILTER_SANITIZE_STRING);
  $case->Description = filter_var(htmlspecialchars_decode($_POST['description']), FILTER_SANITIZE_STRING);
  $case->AppURL__c = filter_var($_POST['fqdn'], FILTER_VALIDATE_DOMAIN, FILTER_FLAG_HOSTNAME);
  $case->SuppliedName = filter_var(htmlspecialchars_decode($_POST['name']), FILTER_SANITIZE_STRING);
  $case->SuppliedEmail = filter_var($_POST['email'], FILTER_VALIDATE_EMAIL);
  $case->SuppliedPhone = filter_var(htmlspecialchars_decode($_POST['phone']), FILTER_SANITIZE_STRING);
  $case->SuppliedCompany = filter_var(htmlspecialchars_decode($_POST['company']), FILTER_SANITIZE_STRING);
