window.jwplayer = function(e) {
    ...
    r = [n(89), n(96), n(1), n(92), n(93), n(33), n(101), n(53), n(52), n(2), n(81), n(3), n(34), n(5), n(4), n(141), n(95)], o = function(e, t, n, i, r, o, s, u, c, d, f, p, h, g, v, m, y) {
        ...
        return E.prototype = {
            ...
            setup: function(o, m) {
                ...
                function E(e, t) {
                    be.trigger(v.JWPLAYER_CONTROLS, {
                        controls: t
                    })
                }
                ...
                function C() {
                    me.change("visibility", k), me.on("change:controls", E), be.trigger(v.JWPLAYER_READY, {
                        setupTime: 0
                    }), be.triggerAfterReady = be.trigger;
                ...
                function x(e, t) {
                    me.get("playOnViewable") && (t ? W() : d.isMobile() && be.pause({
                        reason: "autostart"
                    }))
                }

                function T(e) {
                    var t = me.getProviders(),
                        n = t.required(e, me.get("primary"));
                ...
                function N() {
                    ...
                    if (j(), me.set("playReason", e.reason), me.get("state") !== g.ERROR) {
                        ...
                        if (me.get("state") === g.COMPLETE && (J(!0), G(0)), !ye && (ye = !0, be.triggerAfterReady(v.JWPLAYER_MEDIA_BEFOREPLAY, {
                                playReason: me.get("playReason")
                            }), ye = !1, ve)) return ve = !1, void(ge = null);
                        var i;
                        if (V()) {
                ...
                function z(e, t) {
                    me.set("feedData", t);
                    var i = u(e);
                    return i = u.filterPlaylist(i, me, t), me.set("playlist", i), n.isArray(i) && 0 !== i.length ? (T(i), !0) : (be.triggerError({
                ...
                function Q() {
                    if (V()) {
                        ...
                        ge = Q;
                        var e = me.get("item");
                        return e === me.get("playlist").length - 1 ? void(me.get("repeat") ? K({
                            reason: "repeat"
                        }) : (d.isIOS() && ce(!1), me.set("playOnViewable", !1), me.set("state", g.COMPLETE), be.trigger(v.JWPLAYER_PLAYLIST_COMPLETE, {}))) : void K({
                            reason: "playlist"
                        })
                    }
                }
                ...
                var fe, pe, he, ge, ve, me = this._model,
                    ye = !1,
                    we = !1,
                    be = this,
                    Ee = {},
                ...
                me.setup(ke, Ce), fe = this._view = new f(m, me), he = new i(m, me, fe, z), he.on(v.JWPLAYER_READY, A, this), he.on(v.JWPLAYER_SETUP_ERROR, this.setupError, this), me.mediaController.on("all", w, this), me.mediaController.on(v.JWPLAYER_MEDIA_COMPLETE, function() {
                    ...
                    be.trigger(v.JWPLAYER_FULLSCREEN, {
                        fullscreen: t
                    ...
                    be.trigger(v.JWPLAYER_MEDIA_VOLUME, {
                        volume: t
                    })
                }), me.on("change:mute", function(e, t) {
                    be.trigger(v.JWPLAYER_MEDIA_MUTE, {
                        mute: t
                    })
                }), me.on("change:playbackRate", function(e, t) {
                    be.trigger(v.JWPLAYER_PLAYBACK_RATE_CHANGED, {
                        playbackRate: t,
                    ...
                    be.triggerAfterReady(v.JWPLAYER_CAPTIONS_LIST, {
                        tracks: t,
                        track: me.get("captionsIndex") || 0
                    })
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.now = n, t.dateTime = i;
    var r = window.Date,
        o = window.performance || {
            timing: {}
        },
        a = o.timing.navigationStart || (new r).getTime();
        ...
        return a = function(r) {
            ...
            function u() {
                ...
                if (e) {
                    ...
                    r.get("renderCaptionsNatively") ? p(r.get("id"), t) : s(E, {
                        fontSize: t + "px"
                    })
                }
            }
